                          ...
                          <div className="flex items-start justify-between mb-2">
                            <div>
                              ...
                              <div className="flex items-center gap-1 mt-0.5">
                                ...
                                <span className="w-[7px] h-[7px] rounded-full shrink-0" style={{ backgroundColor: artist.gender === 'female' ? '#DF6689' : '#4E7BD6' }} title={artist.gender === 'female' ? 'F' : 'M'} />
                              </div>
                            </div>
                          </div>
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="w-2 h-2 rounded-full shrink-0" style={{ backgroundColor: viewingArtist.gender === 'female' ? '#DF6689' : '#4E7BD6' }} title={viewingArtist.gender === 'female' ? 'F' : 'M'} />
                  </div>
                </div>
              </div>
