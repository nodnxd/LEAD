      ...
      <main className="min-h-screen bg-[#141414] text-white font-pretendard p-5 lg:p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto">
          ...
          <div className="mt-10 pt-6 border-t border-white/[0.07]">
            <a href="/roster/dashboard" className="flex items-center gap-3 p-4 rounded-2xl border border-[#C48B94]/25 bg-[#C48B94]/[0.06] hover:bg-[#C48B94]/10 text-left transition-all">
              <div className="w-11 h-11 rounded-xl bg-[#C48B94]/15 flex items-center justify-center text-[18px] shrink-0">🎤</div>
              ...
              <span className="text-[#C48B94] text-[18px] font-black shrink-0">→</span>
            </a>
          </div>
        </div>
      </main>
