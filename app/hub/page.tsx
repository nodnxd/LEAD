          ...
          <section>
            ...
            <div className="grid gap-2.5">
              ...
              {(castProjects.length > 0 || canHost) ? (
                <button onClick={() => enterCast()} className="flex items-center gap-3 p-4 rounded-full border border-dashed border-brand-cast/25 bg-brand-cast/[0.03] hover:bg-brand-cast/[0.07] text-left transition">
