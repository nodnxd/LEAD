          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 shadow-2xl">
            {done ? (
              <div className="text-center py-4">
                ...
                <button onClick={() => router.push('/')} className="w-full py-3 rounded-xl bg-[#3E78DB] text-white font-semibold text-[13px] hover:opacity-90 transition-all">로그인하러 가기</button>
              </div>
            ) : !ready ? (
