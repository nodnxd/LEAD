...
//   #E01F00 on #0a0a0a  = 4.12  → 배경으로만. 다크 위 텍스트는 leadOnDark #FF2500(5.2).
//   #E01F00 위 흰 글씨   = 4.81  → 통과. subscrr 원색 #FF2500은 3.81이라 한 단계 눌렀다.
...
export const BRAND: Record<ProductKey, { base: string; on: string; onDark: string; hover: string }> = {
  lead:  { base: '#E01F00', on: '#ffffff', onDark: '#FF2500', hover: '#C41C00' },
